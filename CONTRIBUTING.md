...
First of all: Thanks for your interest in contributing to the CachedList! However, you have to meet some requirements in order to get your changes accepted.
...
2. Execute the following command in the root of your clone of CachedList:
